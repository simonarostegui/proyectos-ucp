...
void mostrarMano(HANDLE hConsole, int cartas_p2, int mano_p2[][50], char mazo[][15]);
...
int main()
{
    ...
    //inicializar la mano del jugador 2
    int mano_p2[2][50];
    for(int i=0; i<2; i++)
    {
       for(int j=0; j<50; j++)
    ...
    //repartir la primera mano del jugador 2
    ...
    if (turno == 2) //chequeamos que no halla una instancia de juego activa
    {
    ...
    do //bucle de juego
    {
        ...
        //cartas del p1
        ar = fopen ("cartas_p1.txt", "r");
        if (ar == NULL) {
            printf("error 1.\n");
            return 1;
        }
        fscanf(ar,"%i",&cartas_p1);
        fclose(ar);
        ...
        printf("\nle quedan %i cartas al oponente: ",cartas_p1);
        ...
        if (turno==2) //chequeamos que sea nuestro turno
        {
            do
            {
                ar = fopen ("contador.txt", "r");
                ...
                printf("\nle quedan %i cartas al oponente: ",cartas_p1);
                    ...
                    for (int i = 0; i<robo_p2 ; i++)
                    {
                        fila = rand()%(4);
                        columna = rand()%(15);
                        mano_p2[0][cartas_p2]=fila;
                        mano_p2[1][cartas_p2]=columna;
                        cartas_p2++;
                    }
                ...
                {
                    printf("|");
                    if (mano_p2[1][i]>=0 && mano_p2[1][i]<13)
                    {
                        switch (mano_p2[0][i])
                        {
                        case 0:
                    ...
                    printf(" %c ", mazo[mano_p2[0][i]][mano_p2[1][i]]);
                    color(hConsole,7); 
                }
                printf("|");
                ...
                if (jugada_tipo == 1)                           //jugar una carta
                {
                    ...
                    jugada_carta--;
                    if (mano_p2[1][jugada_carta]>=13)  
                    {
                        printf("Que color quieres que tome la carta? Azul(1) Verde(2) Rojo(3) Amarillo(4) : \n");
                        scanf("%i",&(ultima_carta[0]));
                        ultima_carta[0]--;
                        ultima_carta[1]=mano_p2[1][jugada_carta];
                        
                        printf("%i",mano_p2[1][jugada_carta]);
                        if (mano_p2[1][jugada_carta]==14)
                        {
                    ...
                    for (int i = jugada_carta; i < cartas_p2 - 1; i++) //reacomodamos las cartas
                        {
                            mano_p2[0][i] = mano_p2[0][i+1];
                            mano_p2[1][i] = mano_p2[1][i+1];
                        }
                    ...
                    else if (mano_p2[1][jugada_carta]>=0 && mano_p2[1][jugada_carta]<13)
                    {
                        if (ultima_carta[0]==mano_p2[0][jugada_carta]||ultima_carta[1]==mano_p2[1][jugada_carta])
                        {
                            ultima_carta[0]=mano_p2[0][jugada_carta];
                            ultima_carta[1]=mano_p2[1][jugada_carta];
                            ...
                            }else if (mano_p2[1][jugada_carta]==11||mano_p2[1][jugada_carta]==10)
                            {
                                ar = fopen ("cartas_p2.txt", "w"); 
                                if (ar == NULL) {
                                    printf("error .\n");
                            ...
                            }else if(mano_p2[1][jugada_carta]<10)
                            {                    
                                ar = fopen ("turno.txt", "w"); //
                                if (ar == NULL) {
                                    printf("error .\n");
                            ...
                            for (int i = jugada_carta; i < cartas_p2 - 1; i++) 
                            {
                                mano_p2[0][i] = mano_p2[0][i+1];
                                mano_p2[1][i] = mano_p2[1][i+1];
                            }
                ...
                { 
                    ...
                    case 'r':
                        ...
                        mano_p2[0][cartas_p1]=fila;
                        mano_p2[1][cartas_p1]=columna;
                        cartas_p2++;
                        ...
                        ar = fopen ("turno.txt", "w"); //
                            ...
                            ar = fopen ("cartas_p2.txt", "w"); //guardamos las cartas iniciles del p1
                            if (ar == NULL) {
                                printf("error .\n");
                                return 1;
                            }
