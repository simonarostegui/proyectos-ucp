...
clases = {
	...
	3:{"Codigo":3,'Nombre': "Hoplo", 'Imagen': 'hoplo.png'},
	0:{"Codigo":4,'Nombre': "Provoc", 'Imagen': 'provoc.png'},
	1:{"Codigo":5,'Nombre': "Secutor", 'Imagen': 'secutor.png'},
	2:{"Codigo":6,'Nombre': "Retarius", 'Imagen': 'rhetarius.png'},
	3:{"Codigo":7,'Nombre': "Scissos", 'Imagen': 'scisoss.png'}}
...
def Seleccion_lvl_desafios_Loop(clases_elegidas):
	...
	for i in range(len(clases_elegidas)):
		imagenes_clases_elegidas.append(Boton(clases[i]["Imagen"],clases[i]["Imagen"],DES_DIR,640,600))
	...
	while True:
		...
		for ju in range(len(clases_elegidas)):
			window.blit(imagenes_clases_elegidas[i].image,imagenes_clases_elegidas[i].rect)
